...
dams = all_dams.loc[all_dams.HUC4 == HUC4].copy()
print("selected {0} dams in this {1}".format(len(dams), HUC4))

print("Reading flowlines")
flowlines = deserialize_gdf("{0}/{1}/flowline.feather".format(src_dir, HUC4))[
    [
        "lineID",
        "NHDPlusID",
        "FType",
...
dams.to_file("{0}/{1}/dams_{1}_qa.shp".format(src_dir, HUC4), driver="ESRI Shapefile")
