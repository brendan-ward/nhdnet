...
for HUC2 in REGIONS.keys():
    ...
    df = df[["NHDPlusID", "floodplain_km2", "nat_floodplain_km2"]]

    serialize_df(
        df, "{0}/nhd/{1}/floodplain_stats.feather".format(src_dir, HUC2), index=False
    )
